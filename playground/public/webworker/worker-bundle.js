!(function () {
  ...
  class r {
    ...
    open(e) {
      ...
      return (
        (o.onload = () => this._loadFile(o.result, t, n)),
    ...
    n =
      ...
      function (e) {
        ...
        i
          ? ((l = __dirname + "/"),
            ...
            (n.readBinary = function (e) {
              var r = n.read(e, !0);
              return r.buffer || (r = new Uint8Array(r)), y(r.buffer), r;
            }),
            ...
            process.on("unhandledRejection", Ke),
            (n.quit = function (e) {
              process.exit(e);
            }),
            (n.inspect = function () {
          ...
          ? ("undefined" != typeof read &&
            ...
            (n.readBinary = function (e) {
              ...
              return "function" == typeof readbuffer
                ...
                : (y("object" == typeof (r = read(e, "binary"))), r);
            }),
        ...
        function b(e, r, t, n) {
          switch (
            ...
            case "double":
              ...
              break;
            default:
              Ke("invalid type for setValue: " + t);
          }
        }
        var k = 0,
          D = 3;
        function S(e, r, t, n) {
          ...
          if (
            ((a = t == D ? n : [Le, Ue, m][t](Math.max(i, s ? 1 : r.length))),
            o)
          ) {
            var u;
            for (n = a, y(0 == (3 & a)), u = a + (-4 & i); n < u; n += 4)
              M[n >> 2] = 0;
            for (u = a + i; n < u; ) P[n++ >> 0] = 0;
            return a;
          }
          if ("i8" === s)
            return (
              e.subarray || e.slice ? R.set(e, a) : R.set(new Uint8Array(e), a),
              a
            );
        ...
        function U(e, r, t) {
          for (var n = 0; n < e.length; ++n) P[r++ >> 0] = e.charCodeAt(n);
          t || (P[r >> 0] = 0);
        }
        function j() {
          var e = (function () {
        ...
        K < 5242880 &&
          ...
          n.buffer
            ...
            ? ((w = new WebAssembly.Memory({ initial: K / 65536 })),
              (A = w.buffer))
            : (A = new ArrayBuffer(K)),
          W(),
          (M[q >> 2] = 5520464);
        ...
        function fe() {
          try {
            ...
            if (n.readBinary) return n.readBinary(ce);
        ...
        function le(e) {
          ...
          function i(e) {
            (n.wasmBinary || (!s && !u) || "function" != typeof fetch
              ...
              .then(e, function (e) {
                p("failed to asynchronously prepare wasm: " + e), Ke(e);
              });
          }
          return (
            n.wasmBinary ||
        ...
        se(ce) ||
          ((ue = ce), (ce = n.locateFile ? n.locateFile(ue, l) : l + ue)),
        ...
        var he = {
          ...
          we = {
            ...
            register: function (e, r) {
              (we.ttys[e] = { input: [], output: [], ops: r }),
                _e.registerDevice(e, we.stream_ops);
            },
            stream_ops: {
              open: function (e) {
                var r = we.ttys[e.node.rdev];
                if (!r) throw new _e.ErrnoError(19);
              ...
              read: function (e, r, t, n, o) {
                if (!e.tty || !e.tty.ops.get_char) throw new _e.ErrnoError(6);
                for (var i = 0, a = 0; a < n; a++) {
                  var s;
                  try {
                    s = e.tty.ops.get_char(e.tty);
                  } catch (e) {
                    throw new _e.ErrnoError(5);
                  }
                  if (void 0 === s && 0 === i) throw new _e.ErrnoError(11);
                  if (null == s) break;
                  i++, (r[t + a] = s);
                }
              ...
              write: function (e, r, t, n, o) {
                if (!e.tty || !e.tty.ops.put_char) throw new _e.ErrnoError(6);
                try {
                  for (var i = 0; i < n; i++)
                ...
                if (!e.input.length) {
                  ...
                  if (i) {
                    ...
                    if (o) {
                      var s = !1;
                      try {
                        (a = Te.openSync("/dev/stdin", "r")), (s = !0);
                      } catch (e) {}
                    }
                    try {
                      n = Te.readSync(a, t, 0, 256, null);
                    } catch (e) {
          ...
          ve = {
            ...
            createNode: function (e, r, t, n) {
              if (_e.isBlkdev(t) || _e.isFIFO(t)) throw new _e.ErrnoError(1);
              ve.ops_table ||
                (ve.ops_table = {
                  dir: {
                    node: {
              ...
              var o = _e.createNode(e, r, t, n);
              return (
                _e.isDir(o.mode)
                  ? ((o.node_ops = ve.ops_table.dir.node),
                    (o.stream_ops = ve.ops_table.dir.stream),
                    (o.contents = {}))
                  : _e.isFile(o.mode)
                  ? ((o.node_ops = ve.ops_table.file.node),
                    (o.stream_ops = ve.ops_table.file.stream),
                    (o.usedBytes = 0),
                    (o.contents = null))
                  : _e.isLink(o.mode)
                  ? ((o.node_ops = ve.ops_table.link.node),
                    (o.stream_ops = ve.ops_table.link.stream))
                  : _e.isChrdev(o.mode) &&
                    ((o.node_ops = ve.ops_table.chrdev.node),
                    (o.stream_ops = ve.ops_table.chrdev.stream)),
            ...
            node_ops: {
              getattr: function (e) {
                var r = {};
                return (
                  (r.dev = _e.isChrdev(e.mode) ? e.id : 1),
                  (r.ino = e.id),
                  (r.mode = e.mode),
                  (r.nlink = 1),
                  (r.uid = 0),
              ...
              setattr: function (e, r) {
                void 0 !== r.mode && (e.mode = r.mode),
                  ...
                  void 0 !== r.size && ve.resizeFileStorage(e, r.size);
              },
              lookup: function (e, r) {
                throw _e.genericErrors[2];
              },
              mknod: function (e, r, t, n) {
                return ve.createNode(e, r, t, n);
              },
              rename: function (e, r, t) {
                if (_e.isDir(e.mode)) {
                  ...
                  if (n) for (var o in n.contents) throw new _e.ErrnoError(39);
                }
              ...
              rmdir: function (e, r) {
                var t = _e.lookupNode(e, r);
                for (var n in t.contents) throw new _e.ErrnoError(39);
                delete e.contents[r];
              },
              readdir: function (e) {
                var r = [".", ".."];
              ...
              symlink: function (e, r, t) {
                var n = ve.createNode(e, r, 41471, 0);
                return (n.link = t), n;
              },
              readlink: function (e) {
                if (!_e.isLink(e.mode)) throw new _e.ErrnoError(22);
                return e.link;
              },
            },
            stream_ops: {
              ...
              llseek: function (e, r, t) {
                ...
                if (
                  ...
                  throw new _e.ErrnoError(22);
                return n;
              },
              allocate: function (e, r, t) {
                ve.expandFileStorage(e.node, r + t),
                  (e.node.usedBytes = Math.max(e.node.usedBytes, r + t));
              },
              mmap: function (e, r, t, n, o, i, a) {
                if (!_e.isFile(e.node.mode)) throw new _e.ErrnoError(19);
                var s,
                  u,
                  c = e.node.contents;
              ...
              msync: function (e, r, t, n, o) {
                if (!_e.isFile(e.node.mode)) throw new _e.ErrnoError(19);
                return 2 & o ? 0 : (ve.stream_ops.write(e, r, 0, n, t, !1), 0);
              },
            },
          },
          ge = {
              ...
              return (
                "object" == typeof window &&
                  (e =
                    ...
                    window.msIndexedDB),
                y(e, "IDBFS used, but indexedDB not supported"),
                e
              );
            },
            DB_VERSION: 21,
            ...
            mount: function (e) {
              return ve.mount.apply(null, arguments);
            },
            syncfs: function (e, r, t) {
              ge.getLocalSet(e, function (n, o) {
                if (n) return t(n);
                ge.getRemoteSet(e, function (e, n) {
                  if (e) return t(e);
                  var i = r ? n : o,
                    a = r ? o : n;
                  ge.reconcile(i, a, t);
            ...
            getDB: function (e, r) {
              ...
              try {
                t = ge.indexedDB().open(e, ge.DB_VERSION);
              } catch (e) {
                return r(e);
              }
              ...
              (t.onupgradeneeded = function (e) {
                ...
                (r = t.objectStoreNames.contains(ge.DB_STORE_NAME)
                  ? n.objectStore(ge.DB_STORE_NAME)
                  : t.createObjectStore(ge.DB_STORE_NAME)).indexNames.contains(
                  "timestamp"
                ) || r.createIndex("timestamp", "timestamp", { unique: !1 });
              }),
                (t.onsuccess = function () {
                  (n = t.result), (ge.dbs[e] = n), r(null, n);
                }),
            ...
            getLocalSet: function (e, r) {
              ...
              for (
                var i = _e.readdir(e.mountpoint).filter(n).map(o(e.mountpoint));
                i.length;
                ...
                _e.isDir(a.mode) &&
                  i.push.apply(i, _e.readdir(s).filter(n).map(o(s))),
            ...
            getRemoteSet: function (e, r) {
              var t = {};
              ge.getDB(e.mountpoint, function (e, n) {
                if (e) return r(e);
                try {
                  var o = n.transaction([ge.DB_STORE_NAME], "readonly");
                  (o.onerror = function (e) {
                    r(this.error), e.preventDefault();
                  }),
                    (o
                      .objectStore(ge.DB_STORE_NAME)
                      .index("timestamp")
            ...
            loadLocalEntry: function (e, r) {
              var t, n;
              try {
                (n = _e.lookupPath(e).node), (t = _e.stat(e));
              } catch (e) {
                return r(e);
              }
              return _e.isDir(t.mode)
                ? r(null, { timestamp: t.mtime, mode: t.mode })
                : _e.isFile(t.mode)
                ? ((n.contents = ve.getFileDataAsTypedArray(n)),
                  r(null, {
                    timestamp: t.mtime,
                    mode: t.mode,
                    contents: n.contents,
            ...
            storeLocalEntry: function (e, r, t) {
              try {
                if (_e.isDir(r.mode)) _e.mkdir(e, r.mode);
                else {
                  if (!_e.isFile(r.mode))
                    return t(new Error("node type not supported"));
                  _e.writeFile(e, r.contents, { canOwn: !0 });
                }
                _e.chmod(e, r.mode), _e.utime(e, r.timestamp, r.timestamp);
              } catch (e) {
                return t(e);
              }
              t(null);
            ...
            reconcile: function (e, r, t) {
              ...
              var a = 0,
                ...
                u = s.objectStore(ge.DB_STORE_NAME);
              function c(e) {
                return e
                  ? c.errored
                    ? void 0
              ...
              (s.onerror = function (e) {
                ...
                o.sort().forEach(function (e) {
                  "local" === r.type
                    ? ge.loadRemoteEntry(u, e, function (r, t) {
                        if (r) return c(r);
                        ge.storeLocalEntry(e, t, c);
                      })
                    : ge.loadLocalEntry(e, function (r, t) {
                        if (r) return c(r);
                        ge.storeRemoteEntry(u, e, t, c);
                      });
                }),
                i
                  .sort()
                  ...
                  .forEach(function (e) {
                    "local" === r.type
                      ? ge.removeLocalEntry(e, c)
                      : ge.removeRemoteEntry(u, e, c);
                  });
            },
          },
          ye = {
            ...
            mount: function (e) {
              return y(i), ye.createNode(null, "/", ye.getMode(e.opts.root), 0);
            },
            createNode: function (e, r, t, n) {
              if (!_e.isDir(t) && !_e.isFile(t) && !_e.isLink(t))
                throw new _e.ErrnoError(22);
              var o = _e.createNode(e, r, t);
              return (
                (o.node_ops = ye.node_ops), (o.stream_ops = ye.stream_ops), o
              );
            },
            getMode: function (e) {
              var r;
              try {
                (r = Te.lstatSync(e)),
                  ye.isWindows && (r.mode = r.mode | ((292 & r.mode) >> 2));
              } catch (e) {
                if (!e.code) throw e;
                throw new _e.ErrnoError(-e.errno);
              }
              return r.mode;
            },
            realPath: function (e) {
              ...
              return (
                r.push(e.mount.opts.root), r.reverse(), pe.join.apply(null, r)
              );
            },
            flagsForNode: function (e) {
              (e &= -2097153), (e &= -2049), (e &= -32769), (e &= -524289);
              var r = 0;
              for (var t in ye.flagsForNodeMap)
                e & t && ((r |= ye.flagsForNodeMap[t]), (e ^= t));
              if (e) throw new _e.ErrnoError(22);
              return r;
            },
            node_ops: {
              getattr: function (e) {
                ...
                return (
                  ye.isWindows && !r.blksize && (r.blksize = 4096),
                  ye.isWindows &&
                    !r.blocks &&
              ...
              setattr: function (e, r) {
                ...
                try {
                  if (
                    (void 0 !== r.mode &&
                      (Te.chmodSync(t, r.mode), (e.mode = r.mode)),
                    void 0 !== r.timestamp)
                  ) {
                    var n = new Date(r.timestamp);
                    Te.utimesSync(t, n, n);
                  }
                  void 0 !== r.size && Te.truncateSync(t, r.size);
                } catch (e) {
                  if (!e.code) throw e;
                  throw new _e.ErrnoError(-e.errno);
                }
              ...
              lookup: function (e, r) {
                var t = pe.join2(ye.realPath(e), r),
                  n = ye.getMode(t);
                return ye.createNode(e, r, n);
              },
              mknod: function (e, r, t, n) {
                ...
                try {
                  _e.isDir(o.mode)
                    ? Te.mkdirSync(i, o.mode)
                    : Te.writeFileSync(i, "", { mode: o.mode });
                } catch (e) {
                  if (!e.code) throw e;
                  throw new _e.ErrnoError(-e.errno);
                }
              ...
              symlink: function (e, r, t) {
                var n = pe.join2(ye.realPath(e), r);
                try {
                  Te.symlinkSync(t, n);
                } catch (e) {
                  if (!e.code) throw e;
              ...
              readlink: function (e) {
                ...
                try {
                  return (
                    (r = Te.readlinkSync(r)),
                    (r = Me.relative(Me.resolve(e.mount.opts.root), r))
                  );
                } catch (e) {
                  if (!e.code) throw e;
                  throw new _e.ErrnoError(-e.errno);
            ...
            stream_ops: {
              open: function (e) {
                var r = ye.realPath(e.node);
                try {
                  _e.isFile(e.node.mode) &&
                    (e.nfd = Te.openSync(r, ye.flagsForNode(e.flags)));
                } catch (e) {
                  if (!e.code) throw e;
                  throw new _e.ErrnoError(-e.errno);
                }
              ...
              close: function (e) {
                try {
                  _e.isFile(e.node.mode) && e.nfd && Te.closeSync(e.nfd);
                } catch (e) {
                  if (!e.code) throw e;
                  throw new _e.ErrnoError(-e.errno);
                }
              ...
              read: function (e, r, t, n, o) {
                if (0 === n) return 0;
                try {
                  return Te.readSync(e.nfd, ye.bufferFrom(r.buffer), t, n, o);
                } catch (e) {
                  throw new _e.ErrnoError(-e.errno);
                }
              },
              write: function (e, r, t, n, o) {
                try {
                  return Te.writeSync(e.nfd, ye.bufferFrom(r.buffer), t, n, o);
                } catch (e) {
                  throw new _e.ErrnoError(-e.errno);
                }
              },
              llseek: function (e, r, t) {
                var n = r;
                if (1 === t) n += e.position;
                else if (2 === t && _e.isFile(e.node.mode))
                  try {
                    n += Te.fstatSync(e.nfd).size;
                  } catch (e) {
                    throw new _e.ErrnoError(-e.errno);
                  }
                if (n < 0) throw new _e.ErrnoError(22);
                return n;
              },
            },
          },
          Ee = {
            ...
            reader: null,
            mount: function (e) {
              y(u), Ee.reader || (Ee.reader = new FileReaderSync());
              var r = Ee.createNode(null, "/", Ee.DIR_MODE, 0),
                t = {};
              function n(e) {
                for (
                  var n = e.split("/"), o = r, i = 0;
                  i < n.length - 1;
                  i++
                ) {
                  var a = n.slice(0, i + 1).join("/");
                  t[a] || (t[a] = Ee.createNode(o, n[i], Ee.DIR_MODE, 0)),
                    (o = t[a]);
                }
                return o;
              }
              ...
              return (
                ...
                (e.opts.blobs || []).forEach(function (e) {
                  Ee.createNode(n(e.name), o(e.name), Ee.FILE_MODE, 0, e.data);
                }),
            ...
            createNode: function (e, r, t, n, o, i) {
              var a = _e.createNode(e, r, t);
              return (
                (a.mode = t),
                (a.node_ops = Ee.node_ops),
                (a.stream_ops = Ee.stream_ops),
                (a.timestamp = (i || new Date()).getTime()),
                y(Ee.FILE_MODE !== Ee.DIR_MODE),
                t === Ee.FILE_MODE
            ...
            stream_ops: {
              read: function (e, r, t, n, o) {
                ...
                var i = e.node.contents.slice(o, o + n),
                  a = Ee.reader.readAsArrayBuffer(i);
              ...
              llseek: function (e, r, t) {
                ...
                if (
                  (1 === t
                    ? (n += e.position)
                    : 2 === t && _e.isFile(e.node.mode) && (n += e.node.size),
                  n < 0)
                )
                  throw new _e.ErrnoError(22);
                return n;
          ...
          _e = {
            ...
            handleFSError: function (e) {
              if (!(e instanceof _e.ErrnoError)) throw e + " : " + j();
              return me(e.errno);
            },
            lookupPath: function (e, r) {
              if (((r = r || {}), !(e = he.resolve(_e.cwd(), e))))
                return { path: "", node: null };
              var t = { follow_mount: !0, recurse_count: 0 };
              for (var n in t) void 0 === r[n] && (r[n] = t[n]);
              if (r.recurse_count > 8) throw new _e.ErrnoError(40);
              for (
                var o = pe.normalizeArray(
                    e.split("/").filter(function (e) {
                      return !!e;
                    }),
                    !1
                ...
                if (
                  ...
                  for (var c = 0; _e.isLink(i.mode); ) {
                    var f = _e.readlink(a);
                    if (
                      ((a = he.resolve(pe.dirname(a), f)),
                      (i = _e.lookupPath(a, {
                        recurse_count: r.recurse_count,
                      }).node),
                      c++ > 40)
                    )
                      throw new _e.ErrnoError(40);
                  }
              }
            ...
            hashName: function (e, r) {
              ...
              return ((e + t) >>> 0) % _e.nameTable.length;
            },
            hashAddNode: function (e) {
              var r = _e.hashName(e.parent.id, e.name);
              (e.name_next = _e.nameTable[r]), (_e.nameTable[r] = e);
            },
            hashRemoveNode: function (e) {
              var r = _e.hashName(e.parent.id, e.name);
              if (_e.nameTable[r] === e) _e.nameTable[r] = e.name_next;
              else
                for (var t = _e.nameTable[r]; t; ) {
                  if (t.name_next === e) {
            ...
            lookupNode: function (e, r) {
              var t = _e.mayLookup(e);
              if (t) throw new _e.ErrnoError(t, e);
              for (
                var n = _e.hashName(e.id, r), o = _e.nameTable[n];
                o;
                o = o.name_next
              ) {
                var i = o.name;
              ...
              return _e.lookup(e, r);
            },
            createNode: function (e, r, t, n) {
              _e.FSNode ||
                ((_e.FSNode = function (e, r, t, n) {
                  e || (e = this),
                    (this.parent = e),
                    (this.mount = e.mount),
                    (this.mounted = null),
                ...
                (_e.FSNode.prototype = {}),
                Object.defineProperties(_e.FSNode.prototype, {
                  read: {
                    get: function () {
              ...
              var o = new _e.FSNode(e, r, t, n);
              return _e.hashAddNode(o), o;
            },
            ...
            mayLookup: function (e) {
              var r = _e.nodePermissions(e, "x");
              return r || (e.node_ops.lookup ? 0 : 13);
            },
            mayCreate: function (e, r) {
              try {
                return _e.lookupNode(e, r), 17;
              } catch (e) {}
            ...
            mayDelete: function (e, r, t) {
              ...
              var o = _e.nodePermissions(e, "wx");
              if (o) return o;
              if (t) {
                if (!_e.isDir(n.mode)) return 20;
                if (_e.isRoot(n) || _e.getPath(n) === _e.cwd()) return 16;
              } else if (_e.isDir(n.mode)) return 21;
              return 0;
            },
            mayOpen: function (e, r) {
              return e
                ? _e.isLink(e.mode)
                  ? 40
                  : _e.isDir(e.mode) &&
                    ("r" !== _e.flagsToPermissionString(r) || 512 & r)
                  ? 21
                  : _e.nodePermissions(e, _e.flagsToPermissionString(r))
                : 2;
            },
            MAX_OPEN_FDS: 4096,
            nextfd: function (e, r) {
              (e = e || 0), (r = r || _e.MAX_OPEN_FDS);
              for (var t = e; t <= r; t++) if (!_e.streams[t]) return t;
              throw new _e.ErrnoError(24);
            },
            ...
            createStream: function (e, r, t) {
              _e.FSStream ||
                ...
                Object.defineProperties(_e.FSStream.prototype, {
                  object: {
                    get: function () {
                      return this.node;
                    },
              ...
              var n = new _e.FSStream();
              for (var o in e) n[o] = e[o];
              e = n;
              var i = _e.nextfd(r, t);
              return (e.fd = i), (_e.streams[i] = e), e;
            },
            ...
            chrdev_stream_ops: {
              open: function (e) {
                var r = _e.getDevice(e.node.rdev);
            ...
            syncfs: function (e, r) {
              ...
              var t = _e.getMounts(_e.root.mount),
                n = 0;
              function o(e) {
                return _e.syncFSRequests--, r(e);
              }
              function i(e) {
            ...
            mount: function (e, r, t) {
              var n,
                o = "/" === t,
                i = !t;
              if (o && _e.root) throw new _e.ErrnoError(16);
              if (!o && !i) {
                var a = _e.lookupPath(t, { follow_mount: !1 });
                if (((t = a.path), (n = a.node), _e.isMountpoint(n)))
                  throw new _e.ErrnoError(16);
                if (!_e.isDir(n.mode)) throw new _e.ErrnoError(20);
              }
            ...
            unmount: function (e) {
              var r = _e.lookupPath(e, { follow_mount: !1 });
              if (!_e.isMountpoint(r.node)) throw new _e.ErrnoError(22);
              var t = r.node,
                n = t.mounted,
                o = _e.getMounts(n);
              Object.keys(_e.nameTable).forEach(function (e) {
                for (var r = _e.nameTable[e]; r; ) {
                  var t = r.name_next;
                  -1 !== o.indexOf(r.mount) && _e.destroyNode(r), (r = t);
                }
              }),
                (t.mounted = null);
            ...
            mknod: function (e, r, t) {
              var n = _e.lookupPath(e, { parent: !0 }).node,
                o = pe.basename(e);
              if (!o || "." === o || ".." === o) throw new _e.ErrnoError(22);
              var i = _e.mayCreate(n, o);
              if (i) throw new _e.ErrnoError(i);
              if (!n.node_ops.mknod) throw new _e.ErrnoError(1);
            ...
            symlink: function (e, r) {
              if (!he.resolve(e)) throw new _e.ErrnoError(2);
              var t = _e.lookupPath(r, { parent: !0 }).node;
              if (!t) throw new _e.ErrnoError(2);
              var n = pe.basename(r),
                o = _e.mayCreate(t, n);
              if (o) throw new _e.ErrnoError(o);
              if (!t.node_ops.symlink) throw new _e.ErrnoError(1);
            ...
            rename: function (e, r) {
              var t,
                ...
                s = pe.basename(r);
              try {
                (t = _e.lookupPath(e, { parent: !0 }).node),
                  (n = _e.lookupPath(r, { parent: !0 }).node);
              } catch (e) {
                throw new _e.ErrnoError(16);
              }
              if (!t || !n) throw new _e.ErrnoError(2);
              if (t.mount !== n.mount) throw new _e.ErrnoError(18);
              var u,
                c = _e.lookupNode(t, a),
                f = he.relative(e, i);
              if ("." !== f.charAt(0)) throw new _e.ErrnoError(22);
              if ("." !== (f = he.relative(r, o)).charAt(0))
                throw new _e.ErrnoError(39);
              try {
                u = _e.lookupNode(n, s);
              } catch (e) {}
              if (c !== u) {
                var l = _e.isDir(c.mode),
                  d = _e.mayDelete(t, a, l);
                if (d) throw new _e.ErrnoError(d);
                if ((d = u ? _e.mayDelete(n, s, l) : _e.mayCreate(n, s)))
                  throw new _e.ErrnoError(d);
                if (!t.node_ops.rename) throw new _e.ErrnoError(1);
                if (_e.isMountpoint(c) || (u && _e.isMountpoint(u)))
                  throw new _e.ErrnoError(16);
                if (n !== t && (d = _e.nodePermissions(t, "w")))
                  throw new _e.ErrnoError(d);
                try {
                  _e.trackingDelegate.willMovePath &&
                    _e.trackingDelegate.willMovePath(e, r);
                } catch (t) {
                  console.log(
                ...
                try {
                  _e.trackingDelegate.onMovePath &&
                    _e.trackingDelegate.onMovePath(e, r);
                } catch (t) {
                  console.log(
            ...
            rmdir: function (e) {
              var r = _e.lookupPath(e, { parent: !0 }).node,
                t = pe.basename(e),
                n = _e.lookupNode(r, t),
                o = _e.mayDelete(r, t, !0);
              if (o) throw new _e.ErrnoError(o);
              if (!r.node_ops.rmdir) throw new _e.ErrnoError(1);
              if (_e.isMountpoint(n)) throw new _e.ErrnoError(16);
              try {
                _e.trackingDelegate.willDeletePath &&
                  _e.trackingDelegate.willDeletePath(e);
              } catch (r) {
                console.log(
              ...
              r.node_ops.rmdir(r, t), _e.destroyNode(n);
              try {
                _e.trackingDelegate.onDeletePath &&
                  _e.trackingDelegate.onDeletePath(e);
              } catch (r) {
                console.log(
            ...
            readdir: function (e) {
              var r = _e.lookupPath(e, { follow: !0 }).node;
              if (!r.node_ops.readdir) throw new _e.ErrnoError(20);
            ...
            unlink: function (e) {
              var r = _e.lookupPath(e, { parent: !0 }).node,
                t = pe.basename(e),
                n = _e.lookupNode(r, t),
                o = _e.mayDelete(r, t, !1);
              if (o) throw new _e.ErrnoError(o);
              if (!r.node_ops.unlink) throw new _e.ErrnoError(1);
              if (_e.isMountpoint(n)) throw new _e.ErrnoError(16);
              try {
                _e.trackingDelegate.willDeletePath &&
                  _e.trackingDelegate.willDeletePath(e);
              ...
              r.node_ops.unlink(r, t), _e.destroyNode(n);
              try {
                _e.trackingDelegate.onDeletePath &&
                  _e.trackingDelegate.onDeletePath(e);
              } catch (r) {
            ...
            readlink: function (e) {
              var r = _e.lookupPath(e).node;
              if (!r) throw new _e.ErrnoError(2);
              if (!r.node_ops.readlink) throw new _e.ErrnoError(22);
              return he.resolve(_e.getPath(r.parent), r.node_ops.readlink(r));
            },
            stat: function (e, r) {
              var t = _e.lookupPath(e, { follow: !r }).node;
              if (!t) throw new _e.ErrnoError(2);
              if (!t.node_ops.getattr) throw new _e.ErrnoError(1);
            ...
            fchmod: function (e, r) {
              ...
              if (!t) throw new _e.ErrnoError(9);
              _e.chmod(t.node, r);
            },
            ...
            fchown: function (e, r, t) {
              ...
              if (!n) throw new _e.ErrnoError(9);
              _e.chown(n.node, r, t);
            },
            truncate: function (e, r) {
              if (r < 0) throw new _e.ErrnoError(22);
              var t;
              if (
                !(t =
                  "string" == typeof e
                    ? _e.lookupPath(e, { follow: !0 }).node
                    : e).node_ops.setattr
              )
                throw new _e.ErrnoError(1);
              if (_e.isDir(t.mode)) throw new _e.ErrnoError(21);
              if (!_e.isFile(t.mode)) throw new _e.ErrnoError(22);
              var n = _e.nodePermissions(t, "w");
            ...
            ftruncate: function (e, r) {
              var t = _e.getStream(e);
              if (!t) throw new _e.ErrnoError(9);
              if (0 == (2097155 & t.flags)) throw new _e.ErrnoError(22);
              _e.truncate(t.node, r);
            },
            utime: function (e, r, t) {
              var n = _e.lookupPath(e, { follow: !0 }).node;
              n.node_ops.setattr(n, { timestamp: Math.max(r, t) });
            },
            open: function (e, r, t, o, i) {
              if ("" === e) throw new _e.ErrnoError(2);
              var a;
              if (
                ((t = void 0 === t ? 438 : t),
                (t =
                  64 & (r = "string" == typeof r ? _e.modeStringToFlags(r) : r)
                    ? (4095 & t) | 32768
                    : 0),
                "object" == typeof e)
              )
                ...
                e = pe.normalize(e);
                try {
                  a = _e.lookupPath(e, { follow: !(131072 & r) }).node;
                } catch (e) {}
              }
              var s = !1;
              if (64 & r)
                if (a) {
                  if (128 & r) throw new _e.ErrnoError(17);
                } else (a = _e.mknod(e, t, 0)), (s = !0);
              if (!a) throw new _e.ErrnoError(2);
              if (
                (_e.isChrdev(a.mode) && (r &= -513),
                65536 & r && !_e.isDir(a.mode))
              )
                throw new _e.ErrnoError(20);
              if (!s) {
                var u = _e.mayOpen(a, r);
                if (u) throw new _e.ErrnoError(u);
              }
              512 & r && _e.truncate(a, 0), (r &= -641);
              var c = _e.createStream(
                {
                  node: a,
                  path: _e.getPath(a),
                  flags: r,
              ...
              try {
                if (_e.trackingDelegate.onOpenFile) {
                  var f = 0;
                  1 != (2097155 & r) && (f |= _e.tracking.openFlags.READ),
                    0 != (2097155 & r) && (f |= _e.tracking.openFlags.WRITE),
                    _e.trackingDelegate.onOpenFile(e, f);
                }
              } catch (r) {
                console.log(
            ...
            close: function (e) {
              if (_e.isClosed(e)) throw new _e.ErrnoError(9);
            ...
            llseek: function (e, r, t) {
              ...
              if (!e.seekable || !e.stream_ops.llseek)
                throw new _e.ErrnoError(29);
              if (0 != t && 1 != t && 2 != t) throw new _e.ErrnoError(22);
              return (
            ...
            read: function (e, r, t, n, o) {
              if (n < 0 || o < 0) throw new _e.ErrnoError(22);
              if (_e.isClosed(e)) throw new _e.ErrnoError(9);
              if (1 == (2097155 & e.flags)) throw new _e.ErrnoError(9);
              if (_e.isDir(e.node.mode)) throw new _e.ErrnoError(21);
              if (!e.stream_ops.read) throw new _e.ErrnoError(22);
              var i = void 0 !== o;
              if (i) {
                if (!e.seekable) throw new _e.ErrnoError(29);
              } else o = e.position;
            ...
            write: function (e, r, t, n, o, i) {
              if (n < 0 || o < 0) throw new _e.ErrnoError(22);
              if (_e.isClosed(e)) throw new _e.ErrnoError(9);
              if (0 == (2097155 & e.flags)) throw new _e.ErrnoError(9);
              if (_e.isDir(e.node.mode)) throw new _e.ErrnoError(21);
              if (!e.stream_ops.write) throw new _e.ErrnoError(22);
              1024 & e.flags && _e.llseek(e, 0, 2);
              var a = void 0 !== o;
              if (a) {
                if (!e.seekable) throw new _e.ErrnoError(29);
              } else o = e.position;
              ...
              try {
                e.path &&
                  _e.trackingDelegate.onWriteToFile &&
                  _e.trackingDelegate.onWriteToFile(e.path);
              } catch (r) {
                console.log(
            ...
            allocate: function (e, r, t) {
              if (_e.isClosed(e)) throw new _e.ErrnoError(9);
              if (r < 0 || t <= 0) throw new _e.ErrnoError(22);
              if (0 == (2097155 & e.flags)) throw new _e.ErrnoError(9);
              if (!_e.isFile(e.node.mode) && !_e.isDir(e.node.mode))
                throw new _e.ErrnoError(19);
              if (!e.stream_ops.allocate) throw new _e.ErrnoError(95);
              e.stream_ops.allocate(e, r, t);
            },
            mmap: function (e, r, t, n, o, i, a) {
              if (1 == (2097155 & e.flags)) throw new _e.ErrnoError(13);
              if (!e.stream_ops.mmap) throw new _e.ErrnoError(19);
            ...
            ioctl: function (e, r, t) {
              if (!e.stream_ops.ioctl) throw new _e.ErrnoError(25);
            ...
            writeFile: function (e, r, t) {
              (t = t || {}).flags = t.flags || "w";
              var n = _e.open(e, t.flags, t.mode);
              if ("string" == typeof r) {
                var o = new Uint8Array(L(r) + 1),
                  i = z(r, o, 0, o.length);
                _e.write(n, o, 0, i, void 0, t.canOwn);
              } else {
                if (!ArrayBuffer.isView(r))
                  throw new Error("Unsupported data type");
                _e.write(n, r, 0, r.byteLength, void 0, t.canOwn);
              }
              _e.close(n);
            },
            cwd: function () {
              return _e.currentPath;
            },
            chdir: function (e) {
              var r = _e.lookupPath(e, { follow: !0 });
              if (null === r.node) throw new _e.ErrnoError(2);
              if (!_e.isDir(r.node.mode)) throw new _e.ErrnoError(20);
              var t = _e.nodePermissions(r.node, "x");
              if (t) throw new _e.ErrnoError(t);
              _e.currentPath = r.path;
            },
            ...
            createDefaultDevices: function () {
              ...
              if (
                ...
                we.register(_e.makedev(5, 0), we.default_tty_ops),
                we.register(_e.makedev(6, 0), we.default_tty1_ops),
            ...
            createSpecialDirectories: function () {
              _e.mkdir("/proc"),
                ...
                _e.mount(
                  {
                    mount: function () {
                      var e = _e.createNode("/proc/self", "fd", 16895, 73);
                      return (
                        (e.node_ops = {
                          lookup: function (e, r) {
                            var t = +r,
            ...
            createStandardStreams: function () {
              n.stdin
                ? _e.createDevice("/dev", "stdin", n.stdin)
                : _e.symlink("/dev/tty", "/dev/stdin"),
                n.stdout
                  ? _e.createDevice("/dev", "stdout", null, n.stdout)
                  : _e.symlink("/dev/tty", "/dev/stdout"),
                n.stderr
                  ? _e.createDevice("/dev", "stderr", null, n.stderr)
                  : _e.symlink("/dev/tty1", "/dev/stderr"),
                _e.open("/dev/stdin", "r"),
                _e.open("/dev/stdout", "w"),
                _e.open("/dev/stderr", "w");
            },
            ensureErrnoError: function () {
              _e.ErrnoError ||
                ((_e.ErrnoError = function (e, r) {
                  (this.node = r),
                ...
                (_e.ErrnoError.prototype.constructor = _e.ErrnoError),
                [2].forEach(function (e) {
                  (_e.genericErrors[e] = new _e.ErrnoError(e)),
                    (_e.genericErrors[e].stack = "<generic error, no stack>");
                }));
            },
            staticInit: function () {
              _e.ensureErrnoError(),
            ...
            quit: function () {
              ...
              var e = n._fflush;
              e && e(0);
              for (var r = 0; r < _e.streams.length; r++) {
                var t = _e.streams[r];
                t && _e.close(t);
              }
            },
            ...
            analyzePath: function (e, r) {
              ...
              try {
                var n = _e.lookupPath(e, { parent: !0 });
                (t.parentExists = !0),
                  (t.parentPath = n.path),
                  (t.parentObject = n.node),
                  (t.name = pe.basename(e)),
                  (n = _e.lookupPath(e, { follow: !r })),
                  (t.exists = !0),
                  (t.path = n.path),
                  (t.object = n.node),
                  (t.name = n.node.name),
            ...
            createFolder: function (e, r, t, n) {
              var o = pe.join2("string" == typeof e ? e : _e.getPath(e), r),
                i = _e.getMode(t, n);
              return _e.mkdir(o, i);
            },
            ...
            createFile: function (e, r, t, n, o) {
              var i = pe.join2("string" == typeof e ? e : _e.getPath(e), r),
                a = _e.getMode(n, o);
              return _e.create(i, a);
            },
            createDataFile: function (e, r, t, n, o, i) {
              var a = r
                  ? pe.join2("string" == typeof e ? e : _e.getPath(e), r)
                  : e,
                s = _e.getMode(n, o),
                u = _e.create(a, s);
              if (t) {
                if ("string" == typeof t) {
                  for (
                    var c = new Array(t.length), f = 0, l = t.length;
                    f < l;
                    ++f
                  )
                    c[f] = t.charCodeAt(f);
                ...
                _e.chmod(u, 146 | s);
                var d = _e.open(u, "w");
                _e.write(d, t, 0, t.length, 0, i), _e.close(d), _e.chmod(u, s);
              }
              return u;
            },
            createDevice: function (e, r, t, n) {
              var o = pe.join2("string" == typeof e ? e : _e.getPath(e), r),
                i = _e.getMode(!!t, !!n);
              _e.createDevice.major || (_e.createDevice.major = 64);
                ...
                _e.registerDevice(a, {
                  ...
                  read: function (e, r, n, o, i) {
                    for (var a = 0, s = 0; s < o; s++) {
                      ...
                      if (void 0 === u && 0 === a) throw new _e.ErrnoError(11);
                      if (null == u) break;
                      a++, (r[n + s] = u);
                    }
            ...
            createLazyFile: function (e, r, t, n, o) {
              ...
              return (
                Object.keys(c.stream_ops).forEach(function (e) {
                  ...
                  f[e] = function () {
                    if (!_e.forceLoadFile(c)) throw new _e.ErrnoError(5);
            ...
            createPreloadedFile: function (e, r, t, o, i, a, s, u, c, f) {
              Browser.init();
              var l = r ? he.resolve(pe.join2(e, r)) : e;
              function d(t) {
                function d(t) {
                  f && f(),
                    u || _e.createDataFile(e, r, t, o, i, c),
                    a && a(),
                    ie();
                }
                var p = !1;
            ...
            saveFilesToDB: function (e, r, t) {
              ...
              var n = _e.indexedDB();
              try {
                var o = n.open(_e.DB_NAME(), _e.DB_VERSION);
              } catch (e) {
                return t(e);
              }
              (o.onupgradeneeded = function () {
                console.log("creating db"),
                  o.result.createObjectStore(_e.DB_STORE_NAME);
              }),
                (o.onsuccess = function () {
                  var n = o.result.transaction([_e.DB_STORE_NAME], "readwrite"),
                    i = n.objectStore(_e.DB_STORE_NAME),
                    a = 0,
                    s = 0,
                    u = e.length;
                  function c() {
                  ...
                  e.forEach(function (e) {
                    var r = i.put(_e.analyzePath(e).object.contents, e);
            ...
            loadFilesFromDB: function (e, r, t) {
              ...
              (o.onupgradeneeded = t),
                (o.onsuccess = function () {
                  var n = o.result;
                  try {
                    var i = n.transaction([_e.DB_STORE_NAME], "readonly");
                  } catch (e) {
                    return void t(e);
                  }
                  var a = i.objectStore(_e.DB_STORE_NAME),
                    s = 0,
                    u = 0,
                    c = e.length;
                  function f() {
                  ...
                  e.forEach(function (e) {
                    var r = a.get(e);
                    (r.onsuccess = function () {
                      _e.analyzePath(e).exists && _e.unlink(e),
                        _e.createDataFile(
                          pe.dirname(e),
                          pe.basename(e),
                          r.result,
          ...
          be = {
            ...
            doStat: function (e, r, t) {
              try {
                ...
                if (
                  e &&
                  e.node &&
                  pe.normalize(r) !== pe.normalize(_e.getPath(e.node))
                )
                  return -20;
                throw e;
              }
            ...
            doMsync: function (e, r, t, n) {
              var o = new Uint8Array(R.subarray(e, e + t));
              _e.msync(r, o, 0, t, n);
            },
            doMkdir: function (e, r) {
              return (
                "/" === (e = pe.normalize(e))[e.length - 1] &&
            ...
            doReadlink: function (e, r, t) {
              ...
              var n = _e.readlink(e),
                o = Math.min(t, L(n)),
                i = P[r + o];
              return C(n, r, t + 1), (P[r + o] = i), o;
            },
            doAccess: function (e, r) {
              if (-8 & r) return -22;
              var t;
              t = _e.lookupPath(e, { follow: !0 }).node;
              var n = "";
              return (
                4 & r && (n += "r"),
                2 & r && (n += "w"),
                1 & r && (n += "x"),
                n && _e.nodePermissions(t, n) ? -13 : 0
              );
            },
            doDup: function (e, r, t) {
              var n = _e.getStream(t);
              return n && _e.close(n), _e.open(e, r, 0, t, t).fd;
            },
            ...
            varargs: 0,
            get: function (e) {
              return (be.varargs += 4), M[(be.varargs - 4) >> 2];
            },
            getStr: function () {
              return I(be.get());
            },
            getStreamFromFD: function () {
              var e = _e.getStream(be.get());
              if (!e) throw new _e.ErrnoError(9);
              return e;
            },
            get64: function () {
              var e = be.get();
          ...
          Se = {
            ...
            createPipe: function () {
              var e = { buckets: [] };
              e.buckets.push({
                buffer: new Uint8Array(Se.BUCKET_BUFFER_SIZE),
                offset: 0,
                roffset: 0,
              });
              var r = Se.nextname(),
                t = Se.nextname(),
                n = _e.createNode(Se.root, r, 4096, 0),
                o = _e.createNode(Se.root, t, 4096, 0);
              (n.pipe = e), (o.pipe = e);
              var i = _e.createStream({
                path: r,
                node: n,
                flags: _e.modeStringToFlags("r"),
                seekable: !1,
                stream_ops: Se.stream_ops,
              });
              n.stream = i;
              var a = _e.createStream({
                path: t,
                node: o,
                flags: _e.modeStringToFlags("w"),
                seekable: !1,
                stream_ops: Se.stream_ops,
              });
            ...
            stream_ops: {
              ...
              read: function (e, r, t, n, o) {
                ...
                y(r instanceof ArrayBuffer || ArrayBuffer.isView(r));
                var c = r.subarray(t, t + n);
                if (n <= 0) return 0;
                if (0 == a) throw new _e.ErrnoError(ke);
                var f = Math.min(a, n),
                  l = f,
                  d = 0;
                for (s = 0; s < i.buckets.length; s++) {
                  ...
                  if (f <= m) {
                    ...
                    f < m ? ((h = h.subarray(0, f)), (p.roffset += f)) : d++,
                      c.set(h);
                    break;
                  }
                ...
                return (
                  d &&
                    d == i.buckets.length &&
                    (d--,
                    (i.buckets[d].offset = 0),
                    (i.buckets[d].roffset = 0)),
              ...
              write: function (e, r, t, n, o) {
                ...
                0 == i.buckets.length
                  ...
                  y(u.offset <= Se.BUCKET_BUFFER_SIZE);
                var c = Se.BUCKET_BUFFER_SIZE - u.offset;
                if (c >= s)
                ...
                for (
                  var f = (a.byteLength / Se.BUCKET_BUFFER_SIZE) | 0,
                    l = a.byteLength % Se.BUCKET_BUFFER_SIZE,
                    d = 0;
                  d < f;
                  d++
                ) {
                  var p = {
                    buffer: new Uint8Array(Se.BUCKET_BUFFER_SIZE),
                    offset: Se.BUCKET_BUFFER_SIZE,
                    roffset: 0,
                  };
                  i.buckets.push(p),
                    p.buffer.set(a.subarray(0, Se.BUCKET_BUFFER_SIZE)),
                    (a = a.subarray(Se.BUCKET_BUFFER_SIZE, a.byteLength));
                }
                return (
                  l > 0 &&
                    ((p = {
            ...
            nextname: function () {
              return (
                Se.nextname.current || (Se.nextname.current = 0),
                "pipe[" + Se.nextname.current++ + "]"
              );
            },
          };
        function Fe() {
        ...
        function Ae(e) {
          ...
          return (
            !!(function (e) {
              ...
              var r = A.byteLength;
              try {
                return -1 !== w.grow((e - r) / 65536) && ((A = w.buffer), !0);
              } catch (e) {
                return !1;
              }
            })(t) && (W(), !0)
        ...
        function Re() {
          if (!Re.called) {
            (Re.called = !0),
              (M[ze() >> 2] = 60 * new Date().getTimezoneOffset());
            var e = new Date(2e3, 0, 1),
              r = new Date(2e3, 6, 1);
            M[Ie() >> 2] = Number(
              e.getTimezoneOffset() != r.getTimezoneOffset()
            );
            var t = a(e),
              n = a(r),
              o = S(Be(t), "i8", k),
        ...
        if ((C("GMT", 277456, 4), _e.staticInit(), i)) {
          var Te = require("fs"),
            Me = require("path");
          ye.staticInit();
        }
        ...
        var xe = {
            ...
            G: function e(r) {
              ...
              e.called
                ? ((o = M[r >> 2]), (t = M[o >> 2]))
                : ((e.called = !0),
                  (de.USER = de.LOGNAME = "web_user"),
                  (de.PATH = "/"),
                  (de.PWD = "/"),
                  (de.HOME = "/home/web_user"),
                  (de.LANG = "C.UTF-8"),
                  (de._ = n.thisProgram),
                  (t = F(1024)),
                  (o = F(256)),
              ...
              try {
                ...
                return (
                  ...
                  (tempI64 = [
                    ...
                    +J(tempDouble) >= 1
                      ? tempDouble > 0
                        ? (0 | re(+ee(tempDouble / 4294967296), 4294967295)) >>>
                          0
                        : ~~+Q(
                            (tempDouble - +(~~tempDouble >>> 0)) / 4294967296
                          ) >>> 0
                ...
                return (
                  (void 0 !== _e && e instanceof _e.ErrnoError) || Ke(e),
                  -e.errno
                );
              }
            },
            ...
            p: function (e, r) {
              ...
              try {
                for (
                  var t = be.get(), n = be.get(), o = (be.get(), 0), i = 0;
                  i < n;
                  i++
                ) {
                  var a = t + 8 * i,
            ...
            m: function (e, r) {
              ...
              try {
                var t = be.getStreamFromFD(),
                  n = be.get();
                return be.doStat(_e.stat, t.path, n);
              } catch (e) {
                return (
                  (void 0 !== _e && e instanceof _e.ErrnoError) || Ke(e),
                  -e.errno
            ...
            D: function (e, r) {
              ...
              try {
                var t = be.getStreamFromFD();
                return _e.open(t.path, t.flags, 0).fd;
              } catch (e) {
                return (
                  (void 0 !== _e && e instanceof _e.ErrnoError) || Ke(e),
                  -e.errno
            ...
            C: function (e, r) {
              ...
              try {
                var t = be.get();
                if (0 == t) throw new _e.ErrnoError(14);
                var n = Se.createPipe();
                return (
                  (M[t >> 2] = n.readable_fd),
                  (M[(t + 4) >> 2] = n.writable_fd),
                  0
                );
              } catch (e) {
                return (
            ...
            A: Fe,
            z: function (e, r, t) {
              R.set(R.subarray(r, r + t), e);
            },
            y: Ae,
            f: function (e) {
              !(function (e, r) {
                (r && n.noExitRuntime && 0 === e) ||
                  (n.noExitRuntime || ((g = !0), n.onExit && n.onExit(e)),
                  n.quit(e, new We(e)));
              })(e);
            },
            x: function (e) {
              return (function (e, r) {
                ...
                (M[(r + 28) >> 2] = o),
                  (M[(r + 36) >> 2] = -60 * t.getTimezoneOffset());
            ...
            e: function () {
              p("missing function: posix_spawn_file_actions_addclose"), Ke(-1);
            },
            k: function () {
              p("missing function: posix_spawn_file_actions_adddup2"), Ke(-1);
            },
            j: function () {
              p("missing function: posix_spawn_file_actions_destroy"), Ke(-1);
            },
            w: function () {
              p("missing function: posix_spawn_file_actions_init"), Ke(-1);
            },
            v: function () {
              return function () {
                return me(11), -1;
          ...
          Oe = n.asm({}, xe, A);
        n.asm = Oe;
        var Ne = (n.___emscripten_environ_constructor = function () {
          ...
          ze = (n.__get_timezone = function () {
            return n.asm.K.apply(null, arguments);
          }),
          Ce = (n.__get_tzname = function () {
          ...
          Ue = (n.stackAlloc = function () {
            return n.asm.ca.apply(null, arguments);
          }),
          je = (n.stackRestore = function () {
          ...
          function r() {
            n.calledRun ||
              ...
              g ||
                ($ ||
                  (($ = !0),
                  n.noFSInit || _e.init.initialized || _e.init(),
                  we.init(),
                  (Se.root = _e.mount(Se, {}, null)),
                  Z(X)),
        ...
        if (
          ...
          (ne = function e() {
            n.calledRun || qe(), n.calledRun || (ne = e);
          }),
          (n.run = qe),
          (n.abort = Ke),
          n.preInit)
  ...
  class o {
    ...
    initFunctions() {
      this.runCode = {
        ...
        getEntryName: this.cwrap("archive_entry_pathname", "string", [
          "number",
        ]),
        getEntryType: this.cwrap("archive_entry_filetype", "number", [
          "number",
        ]),
      ...
      try {
        switch (e.type) {
          ...
          case "LIST_FILES":
            r = !0;
          case "EXTRACT_FILES":
            for (const e of i.entries(r))
              self.postMessage({ type: "ENTRY", entry: e });
